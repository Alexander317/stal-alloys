...
public class StalAlloysItemGroup {
  ...
  public static final ItemGroup STAL_ALLOYS_ITEM_GROUP = Registry.register(
    ...
    FabricItemGroup.builder()
      ...
      .icon(() -> new ItemStack(StalAlloysBlocks.ALLOY_SMELTER))
    ...
    .build() // Must call build() or the group will not appear
  );

  public static void registerItemGroups() {
    StalAlloys.LOGGER.debug("Registering Item Groups for " + StalAlloys.MOD_ID);
